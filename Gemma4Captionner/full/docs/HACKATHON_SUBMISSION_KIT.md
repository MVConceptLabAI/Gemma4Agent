...
| Field | Value |
| --- | --- |
| GitHub Repository | `https://github.com/MVConceptLabAI/Gemma4Agent/tree/gemma4-submission-v15/Gemma4Captionner/full` |
| Demo Application Platform | `Other` |
| Demo Application URL | `https://mvconceptlabai.github.io/Gemma4Agent/demo.html` |
| Docker Image | `ghcr.io/mvconceptlabai/gemma4-captioner:gemma4-submission-v15` |
...
SceneGate samples representative video moments, combines independent visual observations, and uses Gemma 4 31B as the evidence-consolidation writer. A final bounded grounding review preserves useful detail while removing unsupported literal claims. The humorous-tech output uses one visible-scene-tied technology analogy; humorous-non-tech keeps to everyday humour without technical jargon or invented settings.

Public Docker reference verified as a linux/amd64 manifest:
ghcr.io/mvconceptlabai/gemma4-captioner:gemma4-submission-v15
Digest: sha256:851346afa454f6503907de65245fa5f786340f1c151a6cc7d868e5f6428d58eb
...
1. The GitHub link and Docker tag both point to `gemma4-submission-v15`; keep these two references paired.
