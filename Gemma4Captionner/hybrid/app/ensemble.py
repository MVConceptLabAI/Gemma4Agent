...
# W4 can route each style to a different writer while reusing the identical
# observation/fact spine. Unset variables preserve the single-writer v40 path.
W4_STYLE_WRITERS = {
    "formal": os.environ.get("W4_FORMAL_WRITER", WRITER).strip() or WRITER,
    "sarcastic": os.environ.get("W4_SARCASTIC_WRITER", WRITER).strip() or WRITER,
    "humorous_tech": os.environ.get("W4_HUMOROUS_TECH_WRITER", WRITER).strip() or WRITER,
    "humorous_non_tech": os.environ.get("W4_HUMOROUS_NON_TECH_WRITER", WRITER).strip() or WRITER,
}
