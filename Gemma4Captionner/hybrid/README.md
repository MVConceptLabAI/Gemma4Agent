...
This `gemma4-hybrid-w4` experiment keeps Opus 4.5 for the factual `formal`
caption and uses Gemma 4 31B for the three creative W4 writers. All four calls
receive the same cross-checked observation spine.
